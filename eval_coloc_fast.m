...
if param.scaled_sal_box
    accuracy_file_name = ['acc_',num2str(param.wt_BoxSaliency),'_', num2str(param.wt_saliency), '_', num2str(param.max_pixels), '_', num2str(param.optim.lambda0),'_', num2str(param.lapWght),'_new','_', num2str(param.noBoxes), '.mat'];   
else
    accuracy_file_name = ['acc_',num2str(param.wt_BoxSaliency),'_no_scaling_', num2str(param.wt_saliency), '_', num2str(param.max_pixels), '_', num2str(param.optim.lambda0),'_', num2str(param.lapWght),'_new','_', num2str(param.noBoxes), '.mat'];
end
