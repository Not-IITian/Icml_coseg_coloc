...
if 0
    ...
    cc = cell2mat(typeObj) ;
    save_box_file = ['pascal_10_RP/', cc, '_',num2str(param.noBoxes),'.mat'];
   ...
   elseif param.pascal_10
       ...
       box_file = ['pascal_10_RP/', cc,'_',num2str(param.noBoxes), '.mat'];
   ...
   elseif param.MSRC
       box_file = ['MSRC_RP/', cc, '_',num2str(param.noBoxes),'.mat'];
   end 
  ...
  deep_net_name= 'imagenet-caffe-alex.mat' ;
    if 1
     save_box_feat_mat(param,deep_net_name, typeObj)  
    else
